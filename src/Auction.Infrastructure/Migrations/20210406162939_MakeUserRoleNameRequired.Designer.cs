...
namespace Auction.Infrastructure.Migrations
{
    ...
    [Migration("20210406162939_MakeUserRoleNameRequired")]
    partial class MakeUserRoleNameRequired
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserUserRole", b =>
                {
                    b.HasOne("Auction.Core.Entities.UserRole", null)
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Auction.Core.Entities.User", null)
                        .WithMany()
