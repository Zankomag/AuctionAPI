...
namespace Auction.Infrastructure.Migrations
{
    ...
    [Migration("20210407144227_DeleteLotStatusAndChangeDates")]
    partial class DeleteLotStatusAndChangeDates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auction.Core.Entities.UserUserRole", b =>
                {
            ...
            modelBuilder.Entity("Auction.Core.Entities.UserUserRole", b =>
                {
                    b.HasOne("Auction.Core.Entities.User", "User")
                        .WithMany("UserUserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Auction.Core.Entities.UserRole", "UserRole")
                        .WithMany("UserUserRoles")
